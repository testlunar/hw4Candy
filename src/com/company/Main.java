...
public class Main {
    ...
    private static void selectsweets() throws IOException {
        ...
        System.out.println("6 - ореховый праздничный торт");
        ...
        while (!finished) {
            ...
            switch (choice) {
                case "1":
                    Candy candy1 = new Candy("Баточник", 50.99, 10.4, "Шоколадная конфета");
                    box.add(candy1);
                    ...
                    break;
                case "2":
                    Candy candy2 = new Candy("Лебедь", 15.99, 5.5, "Леденец");
                    box.add(candy2);
                    ...
                    break;
                case "3":
                    Marshmallow marshmallow1 = new Marshmallow("Маршмеллоу розовый", 15.0, 3.0, "вкус клубники");
                    ...
                    break;
                case "4":
                    Marshmallow marshmallow2 = new Marshmallow("Маршмеллоу белый", 15.0, 3.0, "вкус ванили");
                ...
                case "6":
                    ...
                    candy3.setName("Ореховый торт");
                    candy3.setPrice(99.99);
                    candy3.setWeight(300.0);
                    candy3.setInfo("Большой праздничный торт");
                    box.add(candy3);
                    totalPrice += candy3.getPrice();
                    totalWeight += candy3.getWeight();
                    System.out.println("Ореховый торт добавлен в подарок");
                    break;
                case "7":
                    finished = true;
                    break;
        ...
        for (Sweets allsweet : box) {
            count++;
            System.out.println(count + ". " + allsweet.getName() + " - " + allsweet.getInfo());
